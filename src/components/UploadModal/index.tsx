          ...
          >
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <button id="close-upload-modal" className="text-gray-500 hover:text-gray-700 transition-all duration-300 cursor-pointer" onClick={onClose}>
              ...
              <div className="mb-6">
                <div className="cursor-pointer border-2 border-dashed border-gray-300 rounded-lg p-6 text-center" id="drop-area">
                  ...
                  <button id="browse-files" className="text-blue-600 font-medium hover:text-blue-800 cursor-pointer">Procurar arquivos</button>
              ...
              <div className="mb-4">
                ...
                <input type="text" id="file-name" className="text-gray-500 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"/>
              </div>
              <div className="mb-4">
                <label htmlFor="file-description" className="block text-sm font-medium text-gray-700 mb-1">Descrição</label>
                <textarea id="file-description" rows={3} className="text-gray-500 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"></textarea>
              </div>
              <div className="flex justify-end">
                <button id="cancel-upload" className="mr-2 px-4 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md cursor-pointer transition-all duration-300" onClick={onClose}>Cancelar</button>
                <button id="confirm-upload" className="px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md cursor-pointer transition-all duration-300">Enviar</button>
              </div>
            </div>
          </motion.div>
        </motion.div>
